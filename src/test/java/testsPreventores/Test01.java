...
public class Test01 {
	 ...
	 */
	private static final String empresa=Configuracion.getPropiedad("Test01","EMPRESA");
	private static final String hora=Configuracion.getPropiedad("Test01","HORA");
	private static final String prioridad=Configuracion.getPropiedad("Test01","PRIORIDAD");
	private static final String calle=Configuracion.getPropiedad("Test01","CALLE");
	private static final String provincia=Configuracion.getPropiedad("Test01","PROVINCIA");
	...
	public void testCase() {
		...
		//busca el mes septiembre 2024
		while(!Objects.equals(driver.findElement(By.xpath("//*[@id=\"root\"]/div/div/div[2]/div[1]/div/div[1]/button/div/div")).getText(),"Septiembre 2024")) {
			driver.findElement(By.xpath("//*[@id=\"root\"]/div/div/div[2]/div[1]/div/div[2]/div[1]/button/div")).click();
			util.waitHalfSecods(0);
		}
			
		//busca el 4 de septiembre
		driver.findElement(By.xpath("//*[@id=\"root\"]/div/div/div[2]/div[1]/div/div[2]/div[2]/div/div[2]/div/div/button[4]")).click();
		util.waitSecods(1);
